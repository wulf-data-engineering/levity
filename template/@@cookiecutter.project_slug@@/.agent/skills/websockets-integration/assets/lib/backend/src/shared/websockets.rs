...
pub struct WebsocketConnections {
    db: Client,
    table_name: crate::aws_config::SsmParameter,
}
...
impl WebsocketConnections {
    ...
    pub async fn new() -> Self {
        ...
        let table_name = crate::aws_config::SsmParameter::new(&config, "/@@ cookiecutter.project_slug @@/websocket-connections-table-name");
